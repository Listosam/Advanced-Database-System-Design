...
def get_list():
    ...
    return bottle.template('shopping_list', shopping_list=shopping_list, template_lookup = ['D:/SKUL/Kent State University/Semester 1/Advanced Database systems/Database Code/Advanced-Database-System-Design/02-Web-Programming/Views'])
